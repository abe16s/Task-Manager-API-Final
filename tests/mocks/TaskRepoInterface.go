...
// TaskRepoInterface is an autogenerated mock type for the TaskRepoInterface type
type TaskRepoInterface struct {
	mock.Mock
}

// AddTask provides a mock function with given fields: task
func (_m *TaskRepoInterface) AddTask(task domain.Task) (*domain.Task, error) {
	ret := _m.Called(task)
...
func (_m *TaskRepoInterface) DeleteTask(id uuid.UUID) error {
	ret := _m.Called(id)
...
func (_m *TaskRepoInterface) GetTaskById(id uuid.UUID) (*domain.Task, error) {
	ret := _m.Called(id)
...
func (_m *TaskRepoInterface) GetTasks() ([]domain.Task, error) {
	ret := _m.Called()
...
func (_m *TaskRepoInterface) UpdateTaskByID(id uuid.UUID, updatedTask domain.Task) error {
...
// NewTaskRepoInterface creates a new instance of TaskRepoInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTaskRepoInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *TaskRepoInterface {
	mock := &TaskRepoInterface{}
	mock.Mock.Test(t)
